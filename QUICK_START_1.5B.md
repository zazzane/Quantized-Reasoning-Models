...
# Run all experiments (requires datasets to be downloaded)
bash scripts/run_all_quantization_1.5b.sh 0
```

This single script will:
1. Generate calibration data
2. Run all 7 quantization methods (13 configurations total)
3. Evaluate each on 6 benchmarks with 3 seeds
4. Generate summary tables

**Estimated time:** 24-48 hours on a single GPU (depends on GPU type and datasets)
