...
1. **AIME-2024**: American Invitational Mathematics Examination 2024 (30 questions)
2. **AIME-2025**: AIME 2025 edition (30 questions)
3. **AIME-90**: Historical AIME problems (90 questions)
4. **MATH-500**: Mathematics dataset subset (500 problems)
5. **GSM8K**: Grade School Math 8K (test set: 1,319 questions)
6. **GPQA-Diamond**: Graduate-level science questions (198 questions)
...
|-----------|---------|---------|---------|------|---------|
| AIME-2024 | __%__ | __%__ | __%__ | __%__ | ±__%__ |
...
|-----------|---------|---------|---------|------|---------|----------|-------------|
| AIME-2024 | __%__ | __%__ | __%__ | __%__ | ±__%__ | __%__ | __% |
...
- Analysis scripts: `scripts/analyze_quantization_results.py`
